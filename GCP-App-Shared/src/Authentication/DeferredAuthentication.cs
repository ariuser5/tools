...
public class DeferredAuthentication : IConfigurableHttpClientInitializer
{
	...
	{
		if (_credentialSource.User != null && _credentialSource.CredentialsPath != null)
		{
			return Authenticator.Authenticate(
				_credentialSource.ClientSecretStream,
				_credentialSource.Scopes,
				_credentialSource.User,
				_credentialSource.CredentialsPath,
				cancellationToken);
		}
		...
		if (_credentialSource.CredentialsPath != null)
		{
			return Authenticator.Authenticate(
				_credentialSource.ClientSecretStream,
				_credentialSource.Scopes,
				credentialsPath: _credentialSource.CredentialsPath,
				cancellationToken: cancellationToken);
		}
